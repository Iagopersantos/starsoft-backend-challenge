...
export class UpdateSeatsAndSessionEntities1769476553498 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a818b702ebcda16173249d60d4" ON "seats" ("session_id", "seat_number", "row") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_73452145ad61a7fc15a8a71c75" ON "sessions" ("movie_name", "session_time", "room") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9de00b2fb6ea7532d17367d081" ON "reservations" ("seat_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4af5055a871c46d011345a255a" ON "reservations" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6b0a68b6082ee14612e6b5cbc4" ON "reservations" ("idempotency_key") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bd389e1e9c16586ff37e739b21" ON "reservations" ("seat_id", "user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_50780cf24053118938ecf2502d" ON "sales" ("reservation_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2f578cfccdab5506b1a1f848ca" ON "sales" ("seat_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5f282f3656814ec9ca2675aef6" ON "sales" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2a866d8df5ebc6425cfb62c82d" ON "sales" ("amount_paid") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4822fe54e6f19e9d4c92dc71a1" ON "sales" ("reservation_id", "seat_id", "user_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "seats" ADD CONSTRAINT "FK_678c034ca5e301023893d721398" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4822fe54e6f19e9d4c92dc71a1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2a866d8df5ebc6425cfb62c82d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5f282f3656814ec9ca2675aef6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2f578cfccdab5506b1a1f848ca"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_50780cf24053118938ecf2502d"`,
    );
    await queryRunner.query(`DROP TABLE "sales"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bd389e1e9c16586ff37e739b21"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6b0a68b6082ee14612e6b5cbc4"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4af5055a871c46d011345a255a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9de00b2fb6ea7532d17367d081"`,
    );
    await queryRunner.query(`DROP TABLE "reservations"`);
    await queryRunner.query(`DROP TYPE "public"."reservations_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_73452145ad61a7fc15a8a71c75"`,
    );
    await queryRunner.query(`DROP TABLE "sessions"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a818b702ebcda16173249d60d4"`,
    );
